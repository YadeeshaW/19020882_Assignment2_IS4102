...
public class ActitimeStepDefinitions extends TestBase {
	...
	public void user_in_the_Users_Page() throws Throwable {
		usersPage = homePage.clickOnUsersLink();
	}

	@When("^User selects the New User button$")
	public void user_selects_the_New_User_button() throws Throwable {
	...
	public void user_Selects_the_Save_and_Send_Invitation_Button() throws Throwable {
		usersPage.clickCreateUserLink();
	}

	@Then("New user is created successfully with first name as {string} and last name as {string}")
